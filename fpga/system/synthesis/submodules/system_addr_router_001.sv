...
(
    ...
    localparam PAD18 = log2ceil(64'h11128 - 64'h11120); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h11128;
    ...
    // ( 0x110d0 .. 0x110e0 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 17'h110d0   ) begin
    ...
    // ( 0x11110 .. 0x11120 )
    if ( {address[RG:PAD17],{PAD17{1'b0}}} == 17'h11110   ) begin
            src_channel = 19'b0000000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x11120 .. 0x11128 )
    if ( {address[RG:PAD18],{PAD18{1'b0}}} == 17'h11120   ) begin
